...
class TestSetService:
    ...
    async def add_test_set(test_set_data: TestSetInput):
        ...
        return TestSetType(id=test_set.id, user_id=test_set.user_id, item_id=test_set.item_id, frequency=test_set.frequency, next_date=test_set.next_date, user=user_data)

    @staticmethod
    async def get_all_test_set():
        list_test_set = await TestSetRepository.get_all()
        return [TestSetType(id=test_set.id, user_id=test_set.user_id, item_id=test_set.item_id, frequency=test_set.frequency, next_date=test_set.next_date) for test_set in list_test_set]
    ...
    async def get_by_id(test_set_id: int):
        ...
        return TestSetType(id=test_set.id, user_id=test_set.user_id, item_id=test_set.item_id, frequency=test_set.frequency, next_date=test_set.next_date, user=user_data, histories=history_data)
